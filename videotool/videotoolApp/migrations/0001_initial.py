# Generated by Django 2.1.2 on 2018-11-06 06:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='QuantumInConnecter',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qdinconnector', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='QuantumOutConnecter',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qdporttype', models.IntegerField()),
                ('qdoutconnector', models.CharField(max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Resolution',
