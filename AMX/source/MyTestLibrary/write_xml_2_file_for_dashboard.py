# -*- coding: utf-8 -*-
"""
Created on Wed May 29 16:26:07 2019
...
class obj:
    def __init__(self,brand,project,sku,testjob,tester,duration,start_time,end_time,testcase_count, \
                 pass_count,fail_count,norun_count,hw_version,sw_version,phase):
        self.brand=str(brand)#'AMX'
        self.project=str(project)#'Banneker'
        self.sku=str(sku)#'endpoint_tx'
        self.testjob=str(testjob)#'video_control'
        ...
        self.tester=str(tester)#'HISNN834'
...
if __name__=='__main__':
    #app = obj()
    output = read_config_file('default.config')#output is a dictionary, contain [brand,project,sku,testjob,tester]
    #app = #obj('AMX','Banneker','endpoint_tx','video_control','HISNN834','00:11:03','2019-05-30_20-13-05','2019-06-02_00-02-33',\
#2,2,0,0,'V0.2','V1.0.1','EV')
    app = obj(output['brand'],output['project'],output['sku'],output['testjob'],output['tester'],'00:11:03','2019-05-30_20-13-05',\
    '2019-06-02_00-02-33',2,2,0,0,'V0.2','V1.0.1','EV')
    writeInfoToXml(app,'beneker_rx_icsp_test20190814.xml')