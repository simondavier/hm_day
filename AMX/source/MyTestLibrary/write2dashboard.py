...
class writetoreport:
    ...
    def __init__(self,duration, start_time, end_time, testcase_count, \
                     pass_count, fail_count, norun_count, hw_version, sw_version, phase):
        output = self.read_config_file(FILENAME)
        self.brand=output['brand']#'AMX'
        self.project=output['project']#'Banneker'
        self.sku=output['sku']#'endpoint_tx'
        self.testjob=output['testjob']#'video_control'
        ...
        self.tester=output['tester']#'HISNN834'
